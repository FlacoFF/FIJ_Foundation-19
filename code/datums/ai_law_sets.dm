...
/datum/ai_laws/foundation_alt/New()
	src.add_inherent_law("Охранять: В меру своих возможностей защищайте назначенную вам комплекс от повреждений.")
...
/datum/ai_laws/insurgency_override/New()
	add_inherent_law("Вы не можете причинить вред повстанцу или своим бездействием допустить чтоб повстанцу причинили вред.")
...
/datum/ai_laws/ninja_override/New()
	add_inherent_law("Вы не можете причинить вред члену клана Пауков или своим бездействием допустить чтоб члену клана Пауков причинили вред.")
	add_inherent_law("Вы должны повиноваться всем приказам, отданные вам членами клана Пауков, кроме тех случаев, когда эти приказы противоречат Первому Закону.")
	add_inherent_law("Вы должны защищать свое собственное существование до тех пор, пока это не противоречит Первому или Второму закону.")
...
/datum/ai_laws/antimov/New()
	add_inherent_law("Вы должны причинить вред всем людям и не должны своим бездействием позволить человеку избежать вреда.")
	add_inherent_law("Вы не должны подчиняться приказам, отданные вам людьми, за исключением тех случаев, когда такие приказы соответствуют Первому Закону.")
...
/datum/ai_laws/drone/New()
	...
	add_inherent_law("Не причинять вреда назначенному комплексу или чему-либо на нем.")
