...
/datum/antagonist/borer
	...
	welcome_text = "Используйте свои способности, чтобы заползти в ухо носителя и слиться с его мозгом. Вы можете взять управление на самого себя только временно и рискуете навредить своему носителю, поэтому будьте предусмотрительны и осторожны; вашему носителю рекомендуется помогать вам, чем он может. Поговорите со своими коллегами с помощью :x."
