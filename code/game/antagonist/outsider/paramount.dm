...
/datum/antagonist/paramount
	...
	welcome_text = "<span class='info'>Когда-то вы были одним из лучших умов своей культуры, а теперь доведены до безумия шепотом воющей тьмы и наделены психическими способностями, которые не поддаются пониманию. Используя C-E и извращенные знания псионики, продвигайте свои планы на станции.</span>"
