...
/datum/antagonist/ninja
	...
	welcome_text = "<span class='info'>Вы - элитный наемный убийца из клана Пауков. В вашем распоряжении множество способностей благодаря нано-усиленной кибер-броне.</span>"
