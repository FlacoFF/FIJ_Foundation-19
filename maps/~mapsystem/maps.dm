...
/datum/map/proc/make_maint_all_access(var/radstorm = 0) // parameter used by torch
	maint_all_access = 1
	priority_announcement.Announce("Ограничение доступа для всех шлюзов ведущих в технические тоннели было снято.", "Внимание!")

/datum/map/proc/revoke_maint_all_access(var/radstorm = 0) // parameter used by torch
	maint_all_access = 0
	priority_announcement.Announce("Ограничение доступа для всех шлюзов ведущих в технические тоннели было восстановлено.", "Внимание!")
